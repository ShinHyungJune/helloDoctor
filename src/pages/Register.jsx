			...
			<div className="area-register">
						...
						<div className="box-wrap">
							<div className="box box01">
								...
								<div className="bottom">
									...
									<div className="m-input-checkbox type02">모두 동의합니다.</div>
				...
				<div className="m-pop type01">
					<div className="m-pop-inner">
						...
						<div className="btns" style="justify-content: center; display:flex;">
							<button type="button" className="m-btn type01" style="width:220px;">확인</button>
						</div>
					</div>
				</div>
			</div>
